...
import com.example.myapplication2020.SesionDescripcion.DescripcionPrincipalActivity
...
class ArriendosRVAdapter(
    private var context: Context,
    private var arriendosList: ArrayList<ArriendoFirebase>
) : RecyclerView.Adapter<ArriendosRVAdapter.ArriendosViewHolder>() {
    ...
    class ArriendosViewHolder(
        ...
        fun bindArriendo(arriendo: ArriendoFirebase) {
            ...
            itemView.setOnClickListener {
                ...
                var intent = Intent(context, DescripcionPrincipalActivity::class.java)
